<div id="sbplus_error_screen" class="animated">
    ...
    <div id="sbplus_error_info">
        ...
        <p><strong>Minimum supported web browser versions</strong>:
            <ul>
                ...
                <li>Mozilla Firefox 35</li>
                <li>Google Chrome 33</li>
                <li>Apple Safari 5</li>
            </ul>
        </p>
        <p>For more information on modern web browsers and how to update, visit <a href="https://whatbrowser.org/" target="_blank">whatbrowser.org</a>.</p>
    </div>
</div>
