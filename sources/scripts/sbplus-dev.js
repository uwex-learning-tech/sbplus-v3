        ...
        if ( $.fn.haveCoreFeatures() ) {
            ...
            $.get( 'assets/sbplus.xml', function( data ) {
                ...
                if ( s === 'parsererror' ) {
                    ...
                    sbplusError.show( 'Something went wrong in the XML!', 'Validate the XML at <a href="https://validator.w3.org/" target="_blank">https://validator.w3.org/' + window.location.href + 'asets/sbplus.xml&charset=%28detect+automatically%29&doctype=Inline&group=0</a>.' );
